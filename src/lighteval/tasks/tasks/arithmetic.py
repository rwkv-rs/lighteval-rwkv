...
_ARITHMETIC_PARQUET_REVISION = "14413db3567723ff76bc468508333b5c7a9dcf5d"
...
arithmetic_1dc = LightevalTaskConfig(
    ...
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_1dc/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
...
arithmetic_2da = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_2da/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_2dm = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_2dm/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_2ds = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_2ds/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_3da = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_3da/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_3ds = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_3ds/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_4da = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_4da/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_4ds = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_4ds/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_5da = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_5da/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
...
arithmetic_5ds = LightevalTaskConfig(
    ...
    hf_repo="EleutherAI/arithmetic",
    hf_subset="default",
    hf_data_files={"validation": "arithmetic_5ds/validation/0000.parquet"},
    hf_revision=_ARITHMETIC_PARQUET_REVISION,
    hf_avail_splits=["validation"],
    evaluation_splits=["validation"],
    few_shots_split=None,
