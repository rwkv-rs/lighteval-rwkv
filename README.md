...
The full configuration reads `SCOREBOARD_API_BASE_URL` and `SCOREBOARD_PUBLICATION_TOKEN` and evaluates every configured split. The G1i manifests require aggregate pool capacities of 1024, 1024, 960, and 320 respectively; the current G1j deployment manifests require 1024, 512, 256, and 248.
